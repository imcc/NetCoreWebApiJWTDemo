...
namespace JWTDemoForNetCore
{
    public class JwtIssuerOptions
    {
        ...
        /// <summary>
        /// "nbf" (Not Before) Claim (default is UTC NOW) 定义在什么时间之前，该jwt都是不可用的
        /// </summary>
        ...
        /// <summary>
        /// "iat" (Issued At) Claim (default is UTC NOW) jwt的签发时间
        /// </summary>
        ...
        /// <summary>
        /// "exp" (Expiration Time) Claim (returns IssuedAt + ValidFor) jwt的过期时间，这个过期时间必须要大于签发时间
        /// </summary>
        ...
        /// <summary>
        /// "jti" (JWT ID) Claim (default ID is a GUID)  jwt的唯一身份标识，主要用来作为一次性token,从而回避重放攻击
        /// </summary>
